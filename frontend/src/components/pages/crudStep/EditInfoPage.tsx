    ...
    <div>
      <div className="relative p-4 w-full h-full md:h-auto">
        <form action="#">
          ...
          <Link
            to="/crud"
            className="absolute top-2.5 right-2.5 inline-flex items-center text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 dark:hover:bg-gray-600 dark:hover:text-white"
          >
            <button
              type="button"
