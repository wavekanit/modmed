...
export default function DocUpdate() {
    ...
    const submit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/api/updateDoctorEducation", {
    ...
    return (
        <>
            <form className="mx-auto w-1/2" onSubmit={submit}>
                <FormWrapper title="">
                    <h3 className="text-lg font-medium text-gray-900 dark:text-white mt-4 divider">Update Education</h3>
