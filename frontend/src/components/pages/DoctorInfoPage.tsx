          ...
          <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
              ...
              <div className="card mx-auto my-3 w-4/6 py-3 bg-white dark:bg-gray-800 relative sm:rounded-lg">
                <div className="input w-4/6 input-bordered flex items-center mx-auto gap-2">
                    ...
                    <button className="btn bg-blue-500 w-16 text-xs text-white mx-2" onClick={SearchClick}>
              ...
              <table className="table table-xs">
                ...
                <tbody>
                {dummy_data.map((val) => (
                          <tr key={val.d_id} className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                            {/* <td className="p-4 w-4">
                              <div className="flex items-center">
                                <input
                                  id={`checkbox-table-search-${val.d_id}`}
                                  type="checkbox"
                                  onClick={(event) => event.stopPropagation()}
                                  className="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                />
                                <label htmlFor={`checkbox-table-search-${val.d_id}`} className="sr-only">checkbox</label>
                              </div>
                            </td> */}
